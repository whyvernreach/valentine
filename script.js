const CONFIG = {
    ...
    confirmTitle: "YEAAAY! Adek Beneran Mau 💗",
    confirmText: "Mulai dari sekarang Adek resmi jadi…",
    ...
    collageSubtitle: "Sejak adek hadir, hal sederhana pun terasa istimewa. Happy Valentine, my favorite person. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `Makasih ya sudah hadir dan bikin hariku selalu terasa cukup. Adek adalah alasan kenapa senyum itu mudah muncul. Semoga hari harimu selalu penuh kehangatan dan kebahagiaan. mas mas jawa ini selalu ada untukmu. Happy Valentine dek kika 💕`,
